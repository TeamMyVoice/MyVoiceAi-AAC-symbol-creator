...
export const HAIR_COLORS = ['Black', 'Brown', 'Blonde', 'Red', 'Gray', 'White'];
export const HAIR_LENGTHS = ['Bald', 'Short', 'Medium', 'Long'];
export const EYE_COLORS = ['Brown', 'Blue', 'Green', 'Hazel'];
export const CLOTHES_COLORS = ['Red', 'Blue', 'Green', 'Yellow', 'Orange', 'Purple', 'Pink', 'Black', 'White', 'Gray', 'Teal', 'Navy'];

export const BODY_SIZES = ['Slim', 'Average', 'Chubby', 'Plus Size'];

export const AAC_ACTIONS = [
  // Emotions & Basics
